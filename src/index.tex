...
% Metadata variables
\newcommand*{\thetitle}{Home – STATUS:6}
\newcommand*{\theauthor}{John Neffenger}
\newcommand*{\thedate}{\today}
\newcommand*{\subject}{John Neffenger, doing business as Status Six Communications}
\newcommand*{\canonical}{https://www.example.com/}
...
\hypersetup{%
    ...
    pdfauthor={\theauthor},
    pdfsubject={\subject},
    pdfkeywords={status:6, sole, proprietorship},
}
